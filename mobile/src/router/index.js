...
const routes = [
  ...
  { path: "/pinyin", name: "PinYin", component: () => import("../views/PinYinView.vue"), meta: { requiresAuth: true } },
  { path: "/pinyin/initials", name: "PinYinInitials", component: () => import("../views/PinYinInitialsView.vue"), meta: { requiresAuth: true } },
  { path: "/pinyin/finals", name: "PinYinFinals", component: () => import("../views/PinYinFinalsView.vue"), meta: { requiresAuth: true } },
  { path: "/pinyin/finals/:final/learn", name: "PinYinFinalLearn", component: () => import("../views/PinYinFinalLearnView.vue"), meta: { requiresAuth: true } },
  { path: "/pinyin/tones", name: "PinYinTones", component: () => import("../views/PinYinTonesView.vue"), meta: { requiresAuth: true } },
  { path: "/pinyin/practice", name: "PinYinPractice", component: () => import("../views/PinYinPracticeView.vue"), meta: { requiresAuth: true } },
